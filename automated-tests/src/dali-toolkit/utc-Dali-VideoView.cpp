...
int UtcDaliVideoViewPlayWithOverlayTextureVisual(void)
{
  ToolkitTestApplication application;
  tet_infoline("UtcDaliVideoViewSetFrameInterpolationInterval_P");
  ...
  DevelVideoView::EnableOffscreenFrameRendering(videoView, true);
...
int UtcDaliVideoViewPlayWithOverlayTextureVisualAfterPlay(void)
{
  ToolkitTestApplication application;
  tet_infoline("UtcDaliVideoViewSetFrameInterpolationInterval_P");
...
int UtcDaliVideoViewPlayWithOverlayTextureVisualReset(void)
{
  ToolkitTestApplication application;
  tet_infoline("UtcDaliVideoViewSetFrameInterpolationInterval_P");
  ...
  videoView.SetProperty(Dali::Toolkit::VideoView::Property::UNDERLAY, false);
...
int UtcDaliVideoViewPlayWithOverlayTextureVisualReset2(void)
{
  ToolkitTestApplication application;
  tet_infoline("UtcDaliVideoViewSetFrameInterpolationInterval_P");
  ...
  DevelVideoView::EnableOffscreenFrameRendering(videoView, false);
...
int UtcDaliVideoViewPlayWithOverlayTextureVisualSetVideoBuffer(void)
{
  ToolkitTestApplication application;
  tet_infoline("UtcDaliVideoViewSetFrameInterpolationInterval_P");
