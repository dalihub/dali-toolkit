...
int UtcDaliToolkitTextSelectionPopupMirroringRTL(void)
{
  ...
  DALI_TEST_EQUALS(PASTE, tableOfButtons.GetChildAt(0).GetProperty<Dali::String>(Dali::Actor::Property::NAME), TEST_LOCATION);
  DALI_TEST_EQUALS(CUT, tableOfButtons.GetChildAt(2).GetProperty<Dali::String>(Dali::Actor::Property::NAME), TEST_LOCATION);
  DALI_TEST_EQUALS(COPY, tableOfButtons.GetChildAt(4).GetProperty<Dali::String>(Dali::Actor::Property::NAME), TEST_LOCATION);
