...
int UtcDaliBuilderTypeCasts(void)
{
  ...
  DALI_TEST_EQUALS(createdActor.GetCurrentProperty<Vector4>(Actor::Property::COLOR_MULTIPLIER), Vector4(0.5f, 0.5f, 0.5f, 1.0f), TEST_LOCATION);
