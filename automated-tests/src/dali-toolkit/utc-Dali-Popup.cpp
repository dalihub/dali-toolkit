...
int UtcDaliPopupOnTouchedOutsideSignal(void)
{
  ...
  DevelActor::SetResizePolicy(popup, ResizePolicy::FIXED, Dimension::ALL_DIMENSIONS);
...
int UtcDaliPopupPropertyContextualMode(void)
{
  ...
  DevelActor::SetResizePolicy(placement, ResizePolicy::FIXED, Dimension::ALL_DIMENSIONS);
...
int UtcDaliPopupSetPopupBackgroundBorderProperty(void)
{
  ...
  DALI_TEST_CHECK(rect != ToExtents(popup.GetProperty(Popup::Property::POPUP_BACKGROUND_BORDER)));
  ...
  DALI_TEST_EQUALS(rect, ToExtents(popup.GetProperty(Popup::Property::POPUP_BACKGROUND_BORDER)), TEST_LOCATION);
  ...
  DALI_TEST_EQUALS(Extents(1, 2, 3, 4), ToExtents(popup.GetProperty(Popup::Property::POPUP_BACKGROUND_BORDER)), TEST_LOCATION);
  ...
  DALI_TEST_EQUALS(Extents(10, 20, 30, 40), ToExtents(popup.GetProperty(Popup::Property::POPUP_BACKGROUND_BORDER)), TEST_LOCATION);
