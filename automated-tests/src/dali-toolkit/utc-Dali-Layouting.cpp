...
int UtcDaliLayouting_HboxLayout_Padding01(void)
{
  ...
  const Extents CONTROL_PADDING = Extents(5.0f, 10.0f, 20.0f, 2.0f );
  tet_printf( "\nAdding Padding to control at index %u \n", PADDED_CONTROL_INDEX );
  controls[PADDED_CONTROL_INDEX].SetProperty(Toolkit::Control::Property::PADDING, CONTROL_PADDING );
...
int UtcDaliLayouting_HboxLayout_Padding03(void)
{
  ...
  const Extents NEW_CONTROL_PADDING = Extents(10.0f, 10.0f, 20.0f, 2.0f );
  tet_printf( "\nChanging Padding to control at index %u \n", PADDED_CONTROL_INDEX );
  controls[PADDED_CONTROL_INDEX].SetProperty(Toolkit::Control::Property::PADDING, NEW_CONTROL_PADDING );
  ...
  tet_printf( "\nIf x position %f then change has not been processed \n", 40.0f + 40.0f + CONTROL_PADDING.start + CONTROL_PADDING.end );
  DALI_TEST_EQUALS( controls[2].GetProperty<Vector3>( Actor::Property::POSITION ), Vector3( xPositionOfControlBeingTested, 380.0f, 0.0f ), 0.0001f, TEST_LOCATION );
