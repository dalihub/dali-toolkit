...
int UtcDaliLayouting_FlexLayout01(void)
{
  ...
  // To see goto https://yogalayout.com/playground/#
...
int UtcDaliLayouting_FlexLayout07(void)
{
  ...
  for( auto&& iter : controls )
  {
    ...
    iter.SetProperty( Toolkit::FlexLayout::ChildProperty::ALIGN_SELF, Toolkit::FlexLayout::ALIGN_AUTO );
    flexBox.Add( iter );
  }
  flexBox.SetParentOrigin( ParentOrigin::CENTER );
  flexBox.SetAnchorPoint( AnchorPoint::CENTER );
  ...
  controls[0].SetProperty( Toolkit::FlexLayout::ChildProperty::ALIGN_SELF, Toolkit::FlexLayout::ALIGN_CENTER );
  controls[1].SetProperty( Toolkit::FlexLayout::ChildProperty::ALIGN_SELF, Toolkit::FlexLayout::ALIGN_FLEX_START );
  controls[2].SetProperty( Toolkit::FlexLayout::ChildProperty::ALIGN_SELF, Toolkit::FlexLayout::ALIGN_FLEX_END );
  controls[3].SetProperty( Toolkit::FlexLayout::ChildProperty::ALIGN_SELF, Toolkit::FlexLayout::ALIGN_STRETCH );
