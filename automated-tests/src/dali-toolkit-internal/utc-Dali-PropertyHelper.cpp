...
int UtcDaliPropertyHelperGetStringFromPropertyWithStringArray(void)
{
  ...
  Property::Value value(Property::Array().Add("Hello World").Add("The Quick Brown Fox").Add("Jumps over the lazy dog"));
...
int UtcDaliPropertyHelperGetStringFromPropertyWithMultipleTypesInArray(void)
{
  ...
  Property::Value value(Property::Array().Add("Hello World").Add("The Quick Brown Fox").Add(1).Add("Jumps").Add(25).Add("Over"));
