...
public class Handle : BaseHandle {
  ...
  public int GetPropertyIndex(string name) {
    int ret = NDalicPINVOKE.Handle_GetPropertyIndex__SWIG_0(swigCPtr, name);
    if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int GetPropertyIndex(int key) {
    int ret = NDalicPINVOKE.Handle_GetPropertyIndex__SWIG_1(swigCPtr, key);
    if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int GetPropertyIndex(Property.Key key) {
    int ret = NDalicPINVOKE.Handle_GetPropertyIndex__SWIG_2(swigCPtr, Property.Key.getCPtr(key));
    if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public int RegisterProperty(int key, string name, Property.Value propertyValue) {
    int ret = NDalicPINVOKE.Handle_RegisterProperty__SWIG_1(swigCPtr, key, name, Property.Value.getCPtr(propertyValue));
    if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int RegisterProperty(string name, Property.Value propertyValue, Property.AccessMode accessMode) {
    int ret = NDalicPINVOKE.Handle_RegisterProperty__SWIG_2(swigCPtr, name, Property.Value.getCPtr(propertyValue), (int)accessMode);
    if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
