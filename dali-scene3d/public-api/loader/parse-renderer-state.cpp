...
const std::map<std::string_view, Type (*)(const std::string_view&)>& GetRendererStateProcessors()
{
  static const std::map<std::string_view, Type (*)(const std::string_view&)> RENDERER_STATE_PROCESSORS{
    {"DEPTH_WRITE", [](const std::string_view&) -> Type
  { return DEPTH_WRITE; }},
    {"DEPTH_TEST", [](const std::string_view&) -> Type
  { return DEPTH_TEST; }},
    {"CULL_FRONT", [](const std::string_view&) -> Type
  { return CULL_FRONT; }},
    {"CULL_BACK", [](const std::string_view&) -> Type
  { return CULL_BACK; }},
    {"ALPHA_BLEND", [](const std::string_view&) -> Type
  { return ALPHA_BLEND; }},
