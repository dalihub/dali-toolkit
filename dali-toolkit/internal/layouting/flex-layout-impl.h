...
#include "../../devel-api/layouting/flex-layout.h"
...
public:
   ...
   */
  Dali::Toolkit::FlexLayout::FlexDirection GetFlexDirection();
   ...
   */
  Dali::Toolkit::FlexLayout::Justification GetFlexJustification();
   ...
   */
  Dali::Toolkit::FlexLayout::WrapType GetFlexWrap();

  /**
   * @copydoc FlexLayout::SetFlexAlignment
   */
  void SetFlexAlignment( Dali::Toolkit::FlexLayout::Alignment flexAlignment );
  /**
   * @copydoc FlexLayout::GetFlexAlignment
   */
  Dali::Toolkit::FlexLayout::Alignment GetFlexAlignment();

  /**
   * @copydoc FlexLayout::SetFlexItemsAlignment
   */
  void SetFlexItemsAlignment( Dali::Toolkit::FlexLayout::Alignment flexAlignment );

  /**
   * @copydoc FlexLayout::GetFlexItemsAlignment
   */
  Dali::Toolkit::FlexLayout::Alignment GetFlexItemsAlignment();
