...
YGSize FlexLayout::OnChildMeasure( YGNodeRef node,
  ...
  oss << "innerWidth:" << innerWidth << " innerHeight:" << innerHeight <<
      " desiredWidth:" << desiredWidth << " desiredHeight:" << desiredHeight <<
      " widthMeasureSpec:" << widthMeasureSpec << " heightMeasureSpec:" << heightMeasureSpec << std::endl;
  ...
  if ( mRoot )
  {
    ...
    for( unsigned int childIndex = 0; childIndex < count; childIndex++)
    {
      ...
      if ( childLayout != nullptr )
      {
        ...
        YGNodeStyleSetMinWidth( childNode, YGUndefined );
        YGNodeStyleSetMinHeight( childNode, YGUndefined );
...
void FlexLayout::OnMeasure( MeasureSpec widthMeasureSpec, MeasureSpec heightMeasureSpec )
{
  ...
  float width = widthMeasureSpec.GetSize();
  float height = heightMeasureSpec.GetSize();
