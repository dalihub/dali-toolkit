...
void FboxLayout::SetFlexAlignment( Dali::Toolkit::FboxLayout::Alignment flexAlignment )
{
  YGNodeStyleSetAlignContent( mRoot, static_cast<YGAlign>(flexAlignment) );
}

Dali::Toolkit::FboxLayout::Alignment FboxLayout::GetFlexAlignment()
{
  return static_cast<Dali::Toolkit::FboxLayout::Alignment>(YGNodeStyleGetAlignContent( mRoot ));
}
...
void FboxLayout::OnChildRemove( LayoutItem& child )
{
