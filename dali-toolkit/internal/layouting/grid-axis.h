...
class GridAxis : public RefObject
{
...
public:
  ...
  void CalculateLocations( int numberOfColumns, unsigned int availableWidth, unsigned int availableHeight, unsigned int numberOfCells );
