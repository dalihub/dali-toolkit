...
const NameIndexMatch NAME_INDEX_MATCH_TABLE[] =
  {
    ...
    {BATCH_SIZE_NAME, Toolkit::ImageVisual::Property::BATCH_SIZE},
    {CACHE_SIZE_NAME, Toolkit::ImageVisual::Property::CACHE_SIZE},
    {FRAME_DELAY_NAME, Toolkit::ImageVisual::Property::FRAME_DELAY},
...
void AnimatedImageVisual::CreateImageCache(TextureManager::ReloadPolicy reloadPolicy)
{
  ...
  if(mAnimatedImageLoading)
  {
    mImageCache = new RollingAnimatedImageCache(textureManager, mDesiredSize, mSamplingMode, mAnimatedImageLoading, mMaskingData, *this, mCacheSize, mBatchSize, mWrapModeU, mWrapModeV, IsSynchronousLoadingRequired(), IsPreMultipliedAlphaEnabled(), reloadPolicy);
  }
  else if(mImageUrls)
  {
