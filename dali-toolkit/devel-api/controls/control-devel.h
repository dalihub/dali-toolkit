 ...
 */
DALI_IMPORT_API Toolkit::LayoutItem GetLayout( Internal::Control& control );
 ...
 * @return A handle to the layout, or empty.
 */
DALI_IMPORT_API Toolkit::LayoutItem GetLayout( Control control );
 ...
 */
DALI_IMPORT_API void SetLayout( Internal::Control& control, Toolkit::LayoutItem layout );
 ...
 * @param[in] layout Pointer to the layout
 */
DALI_IMPORT_API void SetLayout( Control control, Toolkit::LayoutItem layout );
