                                ...
                                MeasureSpec parentHeightMeasureSpec )
{
  ...
  if ( control )
  {
    ...
    if ( desiredWidth > 0  )
    {
      ...
      childOwner.SetProperty( Toolkit::LayoutBase::ChildProperty::WIDTH_SPECIFICATION, LayoutLength::IntType( desiredWidth ) );
    }
    ...
    if ( desiredHeight > 0)
    {
      ...
      childOwner.SetProperty( Toolkit::LayoutBase::ChildProperty::HEIGHT_SPECIFICATION, LayoutLength::IntType( desiredHeight ) );
    }
  }
