                                ...
                                MeasureSpec parentHeightMeasureSpec )
{
  ...
  auto desiredWidth = childOwner.GetProperty<int>( Toolkit::LayoutBase::ChildProperty::WIDTH_SPECIFICATION ); // Width with padding
  ...
  LayoutLength childDimension )
{
  ...
  DALI_LOG_INFO( gLogFilter, Debug::Verbose, "LayoutGroup::GetChildMeasureSpec specSize:%d childDimension:%d \n", MeasureSpec::IntType( specSize ),
                                                                                                                  MeasureSpec::IntType( childDimension ) );
