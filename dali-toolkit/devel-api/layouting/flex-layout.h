 ...
 */
class DALI_IMPORT_API FlexLayout : public LayoutGroup
{
public:

  enum PropertyRange
  {
    CHILD_PROPERTY_START_INDEX = LayoutGroup::CHILD_PROPERTY_START_INDEX+1000,
  ...
  /**
    ...
    */
  Alignment GetFlexItemsAlignment();
